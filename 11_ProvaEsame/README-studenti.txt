...
Si presuppone l'uso di GNU/Linux e di una shell da terminale, non è garantita la correttezza degli script se fatti girare in altri ambienti.



## Scompattare i file

Con 'tar xvf <email studente>.tar' viene espanso l'archivio a partire dalla directory in cui ci si trova.
